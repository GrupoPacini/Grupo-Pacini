...
export const LICENSE_STATUS = ['Ativo', 'Pendente', 'Vencido', 'Renovando', 'Próxima ao Vencimento']
...
export function licenseStatusBadge(status: string) {
...
export function prioridadeBadge(prioridade: string) {
  const map: Record<string, string> = {
